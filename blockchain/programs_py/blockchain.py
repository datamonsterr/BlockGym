...
def customer_join_gymclass(
    ...
    customer.transfer_lamports(company, gymclass.price)
...
def pt_decline_customer(
    ...
    company.transfer_lamports(customer, gymclass.price)   
    gymclass.customer = gymclass.key()
...
def customer_confirm_done(
    ...
    company.transfer_lamports(customer, pt_money)
    company.transfer_lamports(trainer, customer_reward)
